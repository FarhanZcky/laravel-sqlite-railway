...
<head>
    ...
    <title>Tracer Study FKOMINFO</title>
    ...
    <style>
        ...
        .hero {
            ...
            text-align: center;
            padding: 100px 20px;
            background: url("{{ asset('img/Bg.jpg') }}") no-repeat center center/cover;
            color: white;
        }
        ...
        .blur-bg {
    display: inline-block;           /* supaya background hanya sebesar teks */
    color: rgb(255, 255, 255);                    /* teks jadi hitam */
    padding: 10px 20px;              /* kasih ruang biar nggak mepet */
    background: rgba(255, 255, 255, 0.3); /* background transparan */
...
<script>
  ...
  btn.addEventListener("click", () => {
    ...
    <section class="hero" data-aos="fade-up">
        <h1 class="blur-bg">Selamat Datang di Tracer Study FKOMINFO</h1>
<p class="blur-bg" style="color: black;">
  Sistem Tracer Study Fakultas Komunikasi dan Informasi Universitas Garut membantu memantau jejak karier alumni serta memberikan informasi penting untuk pengembangan kampus.
</p>
    ...
    <section data-aos="fade-right">
        ...
        <div class="content-box">
            <div class="content-text">
                <p>
                    Tracer Study adalah survei kepada alumni untuk mengetahui transisi dari dunia kampus ke dunia kerja, relevansi pendidikan, serta kontribusi lulusan di masyarakat. 
                    Hasilnya menjadi dasar pengembangan kurikulum dan peningkatan kualitas pendidikan di FKOMINFO Universitas Garut.
                </p>
            </div>
             <img src="{{ asset('img/tentang.jpg') }}" alt="Tentang Tracer Study" class="img-fluid rounded shadow">
        </div>
    </section>
    
    {{-- Target Responden --}}
    <section data-aos="fade-up">
        <h2>Target Responden Tracer Study</h2>
        <div class="content-box reverse">
            <div class="content-text">
                <p>
                    Tracer study ditujukan bagi seluruh alumni Fakultas Komunikasi dan Informasi Universitas Garut, 
                    baik yang baru lulus maupun yang telah berkarier di dunia kerja. 
                    Partisipasi alumni sangat penting untuk menyediakan data relevan demi peningkatan kualitas pendidikan.
                </p>
            </div>
            <img src="{{ asset('img/target.jpg') }}" alt="Target Responden Tracer Study" class="img-fluid rounded shadow">
        </div>
    </section>

    {{-- Manfaat --}}
    <section data-aos="fade-right">
        <h2>Manfaat Tracer Study</h2>
        <div class="content-box">
            <div class="content-text">
                <p>Beberapa manfaat yang dihasilkan dari tracer study bagi kampus maupun alumni, di antaranya:</p>
                <ul class="mt-4 space-y-2 text-left">
                    <li>✔ Mengukur keterkaitan antara kurikulum dengan kebutuhan dunia kerja.</li>
                    <li>✔ Menyediakan informasi terkait posisi kerja, kompetensi, dan pengalaman alumni.</li>
                    <li>✔ Menjadi dasar pengembangan kualitas pembelajaran di FKOMINFO.</li>
                    <li>✔ Meningkatkan hubungan dan jaringan alumni dengan kampus.</li>
                </ul>
            </div>
            <img src="{{ asset('img/manfaat.jpg') }}" alt="Manfaat Tracer Study" class="img-fluid rounded shadow">
        </div>
    </section>
    ...
    <section data-aos="fade-up">
        ...
        <div class="content-box reverse">
            <div class="content-text">
                <p><strong>Alamat:</strong> Jl. Raya Samarang No. 52A, Garut, Jawa Barat</p>
                <p><strong>Email:</strong> fkominfo@uniga.ac.id</p>
                <p><strong>Telepon:</strong> (0262) 123456</p>
            </div>
      <img src="{{ asset('img/kontak.jpg') }}" alt="contact us" class="img-fluid rounded shadow">
