...
<head>
    ...
    <title>Reset Password - Tracer Study FKOMINFO</title>
...
<div class="flex-center">
    <div class="card">
        ...
        <form action="{{ route('password.update') }}" method="POST">
            ...
            <input type="password" name="password" placeholder="Password Baru" required class="input-field">
            <input type="password" name="password_confirmation" placeholder="Konfirmasi Password Baru" required class="input-field">
