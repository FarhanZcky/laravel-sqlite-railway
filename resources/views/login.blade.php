...
<head>
    ...
    <title>Login - Tracer Study FKOMINFO</title>
...
<div class="flex-center">
    <div class="card">
        ...
        <form action="{{ route('login.submit') }}" method="POST">
            ...
            <input type="password" name="password" placeholder="Masukkan password anda" required class="input-field">
        ...
        <p class="text-center text-sm mt-4">
            Belum punya akun? 
            <a href="{{ route('register.form') }}" class="text-purple-700 hover-underline">Daftar</a>
        </p>

        <p class="text-center text-sm mt-2">
            <a href="{{ route('password.request') }}" class="text-purple-700 hover-underline">Lupa password?</a>
        </p>
    </div>
</div>
